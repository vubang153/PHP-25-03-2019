...
?>
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
        ...
        <div>
        <div>
        <form action="updateLoaiBimProcess.php" method="post" accept-charset="utf-8" name="form2">
            <table border="0" style="margin: auto;height: 200px;">
                <tr>
                    <th colspan="2">CẬP NHẬT LOẠI BỈM</th>
                </tr>
                <tr>
                    <th>Mã loại bỉm</th>
                    <td><input type="text" name="txtMaLoaiBim" value="<?php echo $recordset['ma_loai'];?>" required></td>
                </tr>
                <tr>    
                    <th>Tên loại bỉm</th>
                    <td><input type="text" name="txtTenLoaiBim" value="<?php echo $recordset['ten_loai']; ?>" required></td>
                </tr>
                <tr>
